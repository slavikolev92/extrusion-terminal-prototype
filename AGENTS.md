...
- Physical pallet-weight entry is source-complete, verified, and accepted under
  ...
  two-decimal physical weight per numbered pallet. Once any pallet weight is
  present, completion requires weights for every numbered pallet and pallet
  assignment for every roll. Never reinterpret roll-core tare as physical
  pallet weight.
