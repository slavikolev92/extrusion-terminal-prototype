...
- `TASK-21-ORDER-FINISH-REVIEW.md` — source-complete and locally verified
  unified completion review; it has not yet been deployed. Its original pallet
  placeholder was superseded by completed Task 23.
- `TASK-23-PHYSICAL-PALLET-WEIGHT.md` — source-complete, verified, and accepted
  per-pallet physical transport-weight entry; it has not yet been deployed.
